...
from utils import export_csv_request_trajectory, export_csv_container_trajectory, export_csv_container_timeline, export_csv_request_timeline
...
def run_experiment(
    ...
    for exp_id in params.EXP_EVAL:
        ...
        for episode_per_exp in range(params.MAX_EPISODE_EVAL):
            ...
            # Reset env
            # env.cool_down_openwhisk(params.COOL_DOWN)
            ...
            while episode_done is False:
                ...
                if done:
                    ...
                    export_csv_request_timeline(
                        rm_name=rm,
                        exp_id=exp_id,
                        episode=episode,
                        csv_timeline=request_record.get_csv_request_timeline()
                    )
...
if __name__ == "__main__":
    ...
    for exp_prefix in params.EXP_PREFIX:
        print("")
        print("Running {}, exp {}...".format(name, exp_prefix))
        print("")
        ...
        print("{}, exp {} finished!".format(name, exp_prefix))
